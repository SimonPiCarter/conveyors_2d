...
func _ready():
	...
	frames_library.addFrame("blue", preload("res://godot/frames/jams/blue.tres"), Vector2(-12,-12), false)
	frames_library.addFrame("green", preload("res://godot/frames/jams/green.tres"), Vector2(-12,-12), false)
	frames_library.addFrame("pink", preload("res://godot/frames/jams/pink.tres"), Vector2(-12,-12), false)
	frames_library.addFrame("red", preload("res://godot/frames/jams/red.tres"), Vector2(-12,-12), false)
	frames_library.addFrame("yellow", preload("res://godot/frames/jams/yellow.tres"), Vector2(-12,-12), false)
